...
grid.appendChild(createCard(todoThumb, 'To-Do', 'A simple to do app in the style of the Microsoft to-do website.', 'https://github.com/benl12337/todo2', 'https://youtube.com'));
